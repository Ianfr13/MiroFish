...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for entity in result["entity_types"]:
            ...
            if "attributes" not in entity:
                entity["attributes"] = []
            # Normalize attributes: LLM may return strings instead of {name, description} dicts
            entity["attributes"] = [
                {"name": a, "description": a} if isinstance(a, str) else a
    ...
    def generate_python_code(self, ontology: Dict[str, Any]) -> str:
        ...
        code_lines = [
            ...
            '# (graphiti-core processes ontology via add_episode, no EntityModel base class needed)',
            '',
            '',
            '# ============== 实体类型定义 ==============',
            '',

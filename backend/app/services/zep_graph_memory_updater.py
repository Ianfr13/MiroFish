"""
图谱记忆更新服务
将模拟中的Agent活动动态更新到图谱中（基于 graphiti-core + Neo4j）
"""
...
class GraphMemoryUpdater:
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        Args:
            ...
            api_key: 已弃用，保留用于向后兼容。GraphitiService 自行管理配置。
        """
        self.graph_id = graph_id

        # GraphitiService singleton -- handles its own config
        ...
        logger.info(f"GraphMemoryUpdater 初始化完成: group_id={graph_id}, batch_size={self.BATCH_SIZE}")
    ...
    def start(self):
        ...
        logger.info(f"GraphMemoryUpdater 已启动: group_id={self.graph_id}")
    ...
    def stop(self):
        ...
        logger.info(f"GraphMemoryUpdater 已停止: group_id={self.graph_id}, "
...
# Deprecated aliases for backward compatibility with code that still imports the old names
ZepGraphMemoryUpdater = GraphMemoryUpdater  # deprecated
ZepGraphMemoryManager = GraphMemoryManager  # deprecated
